        ...
        default: /* el resto de instrucciones */
            ...
            switch (solucion_riesgos_datos) {
              ...
              /* INSERTAR CÓDIGO */
                    ...
                    if (escribe_Rdst(MEM_WB.IR) && lee_Rfte1(ID_EX.IR) && MEM_WB.IR.Rdestino == ID_EX.IR.Rfuente1) {
                            WBaEXalu_s = SI;
                            result = wb;
                    }
              ...
              /* INSERTAR CÓDIGO */
                     ...
                     */
                       if (escribe_Rdst(EX_MEM.IR) && lee_Rfte1(ID_EX.IR) && EX_MEM.IR.Rdestino == ID_EX.IR.Rfuente1) {
                            MEMaEXalu_s = SI;
                            result = mem;
                    }
    ...
    switch (solucion_riesgos_datos) {
        case parada:
            ...
            if (escribe_Rdst(ID_EX.IR) && lee_Rfte1(IF_ID.IR) && ID_EX.IR.Rdestino == IF_ID.IR.Rfuente1) 
                ...
                if (escribe_Rdst(ID_EX.IR) && lee_Rfte2(IF_ID.IR) && ID_EX.IR.Rdestino == IF_ID.IR.Rfuente2) 
                {
                    IDstall = SI;
                    IFstall = SI;
                }
             ...
             */
              ...
              if (escribe_Rdst(EX_MEM.IR) && lee_Rfte1(IF_ID.IR) && EX_MEM.IR.Rdestino == IF_ID.IR.Rfuente1) 
                ...
                if (escribe_Rdst(EX_MEM.IR) && lee_Rfte2(IF_ID.IR) && EX_MEM.IR.Rdestino == IF_ID.IR.Rfuente2) 
                {
                    IDstall = SI;
                    IFstall = SI;
                }
        ...
        case cortocircuito:
             ...
             */
              ...
              /* INSERTAR CÓDIGO */
                if (es_load(ID_EX.IR)  && lee_Rfte1(IF_ID.IR) && ID_EX.IR.Rdestino == IF_ID.IR.Rfuente1) 
                {
                    IDstall = SI;
                    IFstall = SI;
                }
                if (es_load(ID_EX.IR)  && lee_Rfte2(IF_ID.IR) && ID_EX.IR.Rdestino == IF_ID.IR.Rfuente2) 
                {
                    IDstall = SI;
                    IFstall = SI;
                }
