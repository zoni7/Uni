...
public class PPhilo extends JPanel implements ActionListener {
    ...
    void simulate(String s) {
        ...
        case 1: 
            ...
            t = new RegularTable(sman);
            for (i=0; i<5; i++) {                
                if (i == 4) philo[i] = new LefthandedPhilo(i, cycles, delay, t); 
        ...
        case 3: 
            ...
            for (i=0; i<5; i++) {
                if (i == 4) {philo[i]=new BothOrNonePhilo(i,cycles,delay,t);}
                else {philo[i]=new Philo(i,cycles,delay,t);}
            }
            break;
        case 4: 
            ...
            for (i=0; i<5; i++) {
                if (i == 4) {philo[i]=new LimitedPhilo(i,cycles,delay,t);}
                else {philo[i]=new Philo(i,cycles,delay,t);}
            }
            break;
        }
