...
public class Ordenacion {
     ...
     */
    // This helper method is a public method, the oder one is private 
    ...
    */
    ...
    private static <T extends Comparable<T>> T[] merge2(T[] v1, T[] v2) {
        ...
        // The performance is incresed because we have avoided the last "for" that makes the copies recursibly, so the performance is increased a lot.
        // for (a = i, k = 0; a <= f; a++, k++) { v[a] = aux[k]; }
        return aux;
    }
